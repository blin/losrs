...
test_card_output!(root_help, vec!["--help"], Vec::<(&str, &str)>::new(), vec![""]);

test_card_output!(show_help, vec!["show", "--help"], Vec::<(&str, &str)>::new(), vec![""]);
...
test_card_output!(metadata_help, vec!["metadata", "--help"], Vec::<(&str, &str)>::new(), vec![""]);
...
test_card_output!(review_help, vec!["review", "--help"], Vec::<(&str, &str)>::new(), vec![""]);
